...
class SummaryViewController: UIViewController {
    ...
    func displayInfo(){
        ...
        for i in 0...patientInfo.count - 1{
            ...
            let tempLabel = UILabel(frame: CGRectMake(middleScreen - 150 - 10, 10 + 60 * CGFloat(i), 150, 30))
            ...
            let tempValue = UILabel(frame: CGRectMake(middleScreen + 10, 10 + 60 * CGFloat(i), 145, 30))
        ...
        let imgStart = patientInfo.count * 70
